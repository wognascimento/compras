param(
    [string]$ServerUploadPath = "root@192.168.0.49:/var/www/updates/downloads/compras/",
    [string]$UpdateBaseUrl = "http://192.168.0.49/downloads/compras",
...
$projectFile = Join-Path $projectPath "Compras\Compras.csproj"
...
if (-not $installerFile) {
    throw "Instalador nao encontrado em '$installerPath'."
}
