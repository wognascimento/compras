...
$serverUploadPath = "root@192.168.0.49:/var/www/updates/downloads/compras/"
...
$updateJson = @{
    ...
    updateUrl = "http://192.168.0.49/downloads/compras/$zipFileName"
    changelog = @(
        "Ajustes",
        "Melhorias"
    )
...
scp "$projectPath\version.json" "root@192.168.0.49:/var/www/updates/downloads/compras/version.json"
...
Copy-Item -Path "$projectPath\Output\Compras.exe"  -Destination "RedeTemp:"
